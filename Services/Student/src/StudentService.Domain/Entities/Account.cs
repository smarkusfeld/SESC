...
{
    /// <summary>
    /// Account Entity. Aggregate Entity for <seealso cref="Transcript"/> , <seealso cref="CourseResult"/>, <seealso cref="Enrolment"/>, <seealso cref="Registration"/>
    /// </summary>
    public class Account : BaseAuditableEntity, IAggregateRoot
    {
        ...
        public bool Register(int courseId)
        {
            ...
            if(Registrations.Any(x => x.CourseId == courseId))
            {
                return false;
            }
