...
namespace LibraryService.Api.Controllers
{
    ...
    {
        private readonly ILibraryTransactionService _service;
        ...
        public TransactionController(ILogger<TransactionController> logger, LibraryTransactionService service)
        {
            _logger = logger;
            _service = service;
        }
